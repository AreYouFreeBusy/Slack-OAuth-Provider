...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Slack OAuth 2.0 middleware
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Auth",
        Justification = "OAuth2 is a valid word.")]
    public class SlackApplyRedirectContext : BaseContext<SlackAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The Slack middleware options</param>
        ...
        public SlackApplyRedirectContext(IOwinContext context, SlackAuthenticationOptions options,
